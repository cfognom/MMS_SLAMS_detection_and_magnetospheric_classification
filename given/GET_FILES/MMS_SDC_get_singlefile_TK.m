function MMS_SDC_get_singlefile_TK(start_date,end_date,sc_id,instrument_id,data_rate_mode,data_level,descriptor)
...
output_directory = 'C:\Users\tomask\Documents\Space Physics\Data\';
...
%output_file = ['download_ions_' start_date '--'  end_date(6:10) '.zip'];
%
